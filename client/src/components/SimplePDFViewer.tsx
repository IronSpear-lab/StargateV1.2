      ...
      <DialogContent className="max-w-6xl h-[90vh] p-0 gap-0 bg-white">
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-1 overflow-hidden">
            {/* PDF Viewer area - Direct object tag */}
            <div className="flex-1 relative overflow-auto bg-gray-100 flex justify-center">
              <object 
                data={pdfSrc} 
              ...
              >
                <div className="p-8 text-center">
                  <p className="mb-4 text-red-500">Det går inte att visa PDF-filen direkt.</p>
